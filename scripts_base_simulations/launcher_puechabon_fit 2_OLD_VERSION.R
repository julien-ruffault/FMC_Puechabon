...
soilParameters_path       <- paste0(mainDir,'/projects/Puechabon_fit/Soil_Puechabon_OK_LFMC.csv')
...
vegetation_parameters$gmin20 = 0.5 #2
...
filename  = paste0(pathDir,"/test_FMC_Puechabon.csv")
