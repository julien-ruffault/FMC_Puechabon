...
plot(FMCall85_4$year,rowMeans(FMCall85_4[,-1]),'l')
plot(FMCall45_4$year,rowMeans(FMCall45_4[,-1]),'l')
...
# legend(x=2007,y=33, bty="n",cex=0.75,
...
# box(lwd=.5)
# mtext(side=1,cex=0.72,'Year',line=1.2)
# mtext(side=2,cex=0.72,expression(LFMC[min]*' (% dry mass)'),line=1.8)
...
box(lwd=.5)
mtext(side=1,cex=0.72,'Year',line=1.2)
mtext(side=2,cex=0.72,'Cavitation (%)',line=1.8)
